							...
							<c:if test="${edate > today}">
								<div class="item">
									...
									<div class="chdetail">
										...
										<div class="text3">
											경험치
											<div class="text7">${dto.chexp}P</div>
										</div>
										<div class="text4">
											성공조건
											...
											<c:if test="${dto.chnum == dto2.chnum}">
												...
												<c:if test="${dto2.nickname < dto.chmaxp}">
													<form class="buttonout" action="/challenge/${dto.chnum }" method="get">
														<input class="button" type="submit" value="참가하기"> <input type="hidden" name="chnumdetail" value="${dto.chnum }">
													</form>
												</c:if>
												<c:if test="${dto2.nickname == dto.chmaxp}">
													<form class="buttonout" action="/challenge/${dto.chnum }" method="get">
						...
						<c:if test="${sdate > today}">
							<div class="item">
								...
								<div class="chdetail2">
									...
									<div class="buttonout">
										<input class="button" type="submit" value="오픈예정">
