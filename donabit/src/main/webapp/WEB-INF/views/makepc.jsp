				...
				<div class="leftbox">
					<div class="profilebox">
						...
						<div class="listContainer">
							...
							<div class="listContainerText"><a href="/passwordmodifyform" class="setting"> 비밀번호 변경하기 </a>
							</div>
				...
				<div class="rightbox">
					<main class="admin_main_container">
						<div class="admin_main_contents">
							...
							<br>
							<form class="admin_make_challenge_form" action="/makepc" method="post"
								...
								<div class="admin_make_challenge_table">
									...
									<div class="admin_make_challenge">
										...
										<div class="admin_make_challenge_input">
											<input type="text" name="chname" pattern="^[a-zA-Z0-9가-힣\s]+$"
												maxlength="10" placeholder="한글, 영문, 숫자 10자 이내로 작성해 주세요.">
									...
									<div class="admin_make_challenge">
										...
										<div class="admin_make_challenge_input">
											<textarea name="chdesc" id="chdesc"
												placeholder="100자 이내로 작성해 주세요."></textarea>
									...
									<div class="admin_make_challenge">
										...
										<div class="admin_make_challenge_input">
											<img src="../img/upload_default.png" alt="default image for upload"
												id="uploadImage">
									...
									<div class="admin_make_challenge">
										...
										<div class="admin_make_challenge_input">
											<input type="date" name="chsdate" id="chsdate"><input type="date"
												name="chedate" id="chedate" disabled>
									...
									<div class="admin_make_challenge">
										...
										<div class="admin_make_challenge_input">
											<span class="radioBtns"><input type="radio" name="chexp" id="chexp10"
													value="10" checked><label for="chexp10"
													class="radioLabel">10exp</label></span>
											<span class="radioBtns"><input type="radio" name="chexp" id="chexp15"
													value="15"><label for="chexp15"
													class="radioLabel">15exp</label></span>
											<span class="radioBtns"><input type="radio" name="chexp" id="chexp20"
													value="20"><label for="chexp20"
													class="radioLabel">20exp</label></span>
											<div class="admin_make_challenge_info">(개인별 챌린지가 1회 성공할 때 제공될 경험치를 선택해주세요.)
											</div>
										</div>
									</div>
									<div class="admin_make_challenge">
										...
										<div class="admin_make_challenge_input">
											<span class="radioBtns"><input type="radio" name="chsuccess"
													id="chsuccess30" value="30" checked><label for="chsuccess30"
													class="radioLabel">30회</label></span>
											<span class="radioBtns"><input type="radio" name="chsuccess"
													id="chsuccess66" value="66"><label for="chsuccess66"
													class="radioLabel">66회</label></span>
											<span class="radioBtns"><input type="radio" name="chsuccess"
													id="chsuccess100" value="100"><label for="chsuccess100"
													class="radioLabel">100회</label></span>
									...
									<div class="admin_make_challenge">
										...
										<div class="admin_make_challenge_input">
											<span class="radioBtns"><input type="radio" name="chmaxp" id="chmaxp20"
													value="20" checked><label for="chmaxp20"
													class="radioLabel">20명</label></span>
											<span class="radioBtns"><input type="radio" name="chmaxp" id="chmaxp50"
													value="50"><label for="chmaxp50"
													class="radioLabel">50명</label></span>
											<span class="radioBtns"><input type="radio" name="chmaxp" id="chmaxp100"
													value="100"><label for="chmaxp100"
													class="radioLabel">100명</label></span>
											<div class="admin_make_challenge_info">(챌린지의 모집 인원을 선택해 주세요.)</div>
										</div>
									</div>
									<div class="admin_make_challenge">
										<label for="chdonate" class="admin_make_challenge_label">챌린지 전체 성공 횟수<br>(기부
											조건)</label>
										<div class="admin_make_challenge_input">
											<input type="text" name="chdonate" id="chdonate" value="600" readonly>
											<div class="admin_make_challenge_info">(개인별 목표 횟수 및 모집 인원을 입력하면 자동으로 입력됩니다.)
											</div>
										</div>
									</div>
								</div>
								<div class="admin_make_challenge_btn_container">
									<button class="admin_make_challenge_btn" type="submit"
										onclick="if(!confirm('챌린지를 개설하시겠습니까?')){return false;}">만들기</button>
									<button class="admin_make_challenge_btn" type="reset"
